                            ...
                            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                ...
                                <nav class="nav-primary hidden-xs">
                                    ...
                                    <ul class="nav nav-main" data-ride="collapse">
                                        ...
                                        <li>
                                            <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <b class="badge bg-danger pull-right">4</b> <i class="i i-stack icon"> </i> <span class="font-bold">ABCD School</span> </a>
                                            <ul class="nav dk">
                                                <li>
                                                    <a href="layout-color.html" class="auto"> <i class="i i-dot"></i> <span>Teachers List</span> </a>
                                                </li>
                                                <li>
                                                    <a href="layout-hbox.html" class="auto"> <i class="i i-dot"></i> <span>Students List</span> </a>
                                                </li>
                                                <li>
                                                    <a href="layout-boxed.html" class="auto"> <i class="i i-dot"></i> <span>Staff List</span> </a>
                                                </li>
                                            </ul>
                                        </li>
                                    ...
                                    <div class="text-muted text-xs hidden-nav-xs padder m-t-sm m-b-sm">People of this school</div>
                                    <ul class="nav">
                                        <li>
                                            <a href="http://localhost/Assignment%20School%20data/Teacher/index.php"> <i class="i i-circle-sm text-info-dk"></i> <span>Teachers List</span> </a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/Assignment%20School%20data/Student/index.php"> <i class="i i-circle-sm text-success-dk"></i> <span>Students List</span> </a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/Assignment%20School%20data/Staff/index.php"> <i class="i i-circle-sm text-danger-dk"></i> <span>Staff List</span> </a>
                                        </li>
                                    </ul>
                                    <div class="text-muted text-xs hidden-nav-xs padder m-t-sm m-b-sm">Patron of school</div>
                                    <ul class="nav">
                                        <li>
                                            <a href="#"> <i class="i i-circle-sm-o text-success-lt"></i> <span>Chairman</span> </a>
                                        </li>
                                        <li>
                                            <a href="#"> <i class="i i-circle-sm-o text-warning"></i> <span>Principal</span> </a>
                                        </li>
                                    </ul>
                                </nav>
                                <!-- / nav -->
                            ...
                            <section class="vbox">
                                <section class="scrollable padder">
                                    ...
                                    <section class="row m-b-md">
                                        <div class="col-sm-6">
                                            <h3 class="m-b-xs text-black">ABCD School</h3> <small>Welcome back, Chattogram, <i class="fa fa-map-marker fa-lg text-primary"></i> Bangladesh</small> </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <a style="padding:12px 37px 12px 37px;" class="btn btn-lg btn-primary" href="http://localhost/Assignment%20School%20data/Teacher/index.php">Teachers List</a></br>
                                        <br>
                                        <a style="padding:12px 37px 12px 37px;" class="btn btn-lg btn-primary" href="http://localhost/Assignment%20School%20data/Student/index.php">Students List</a></br>
                                        <br>
                                        <a style="padding:12px 50px 12px 50px;" class="btn btn-lg btn-primary" href="http://localhost/Assignment%20School%20data/Staff/index.php">Staffs List</a></br>

                                        </div>
                                        <div style="margin:0px 0px 0px 30px;" class="col-sm-3">
                                            <section class="panel b-a">
                                                <header class="panel-heading b-b b-light">
                                                    ...
                                                    </ul>Activities</header>
                                                <div class="panel-body text-center bg-light lter" id="b-c">
                                                    <div class="easypiechart inline m-b m-t" data-percent="90" data-line-width="4" data-bar-Color="#23aa8c" data-track-Color="#c5d1da" data-color="#2a3844" data-scale-Color="false" data-size="120" data-line-cap='butt' data-animate="2000">
                                                        <div> <span class="h2 m-l-sm step"></span>%
                                                            <div class="text text-xs">Teachers</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </section>
                                        ...
                                        <div class="col-sm-3">
                                            <section class="panel b-a">
                                                ...
                                                <div class="panel-body text-center bg-light lter" id="b-c">
                                                    <div class="easypiechart inline m-b m-t" data-percent="90" data-line-width="4" data-bar-Color="#23aa8c" data-track-Color="#c5d1da" data-color="#2a3844" data-scale-Color="false" data-size="120" data-line-cap='butt' data-animate="2000">
                                                        <div> <span class="h2 m-l-sm step"></span>%
                                                            <div class="text text-xs">Students</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </section>
                                        ...
                                        <div class="col-sm-3">
                                            <section class="panel b-a">
                                                ...
                                                <div class="panel-body text-center bg-light lter" id="b-c">
                                                    <div class="easypiechart inline m-b m-t" data-percent="90" data-line-width="4" data-bar-Color="#23aa8c" data-track-Color="#c5d1da" data-color="#2a3844" data-scale-Color="false" data-size="120" data-line-cap='butt' data-animate="2000">
                                                        <div> <span class="h2 m-l-sm step"></span>%
                                                            <div class="text text-xs">Staffs</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </section>
